...
@Component({
  selector: 'app-cierre-actas-examenes',
  templateUrl: './cierre-actas-examenes.component.html',
  styleUrls: ['./cierre-actas-examenes.component.css']
})
export class CierreActasExamenesComponent implements OnInit {

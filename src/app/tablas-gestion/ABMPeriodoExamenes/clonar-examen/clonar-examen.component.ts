...
@Component({
  selector: 'app-clonar-examen',
  templateUrl: './clonar-examen.component.html',
  styleUrls: ['./clonar-examen.component.css'],
  providers: [
    {provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE]},
    {provide: MAT_DATE_FORMATS, useValue: MY_FORMATS},
  ]
})
export class ClonarExamenComponent implements OnInit {

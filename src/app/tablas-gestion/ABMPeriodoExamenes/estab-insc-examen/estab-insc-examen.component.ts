...
@Component({
  selector: 'app-estab-insc-examen',
  templateUrl: './estab-insc-examen.component.html',
  styleUrls: ['./estab-insc-examen.component.css'],
  providers: [
    {provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE]},
    {provide: MAT_DATE_FORMATS, useValue: MY_FORMATS},
  ]
})
export class EstabInscExamenComponent implements OnInit {

...
@Component({
  selector: 'app-asignar-docente-lectivo',
  templateUrl: './asignar-docente-lectivo.component.html',
  styleUrls: ['./asignar-docente-lectivo.component.css']
})
export class AsignarDocenteLectivoComponent implements OnInit {

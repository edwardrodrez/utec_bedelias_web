...
@Component({
  selector: 'app-mod-p-lectivo',
  templateUrl: './mod-p-lectivo.component.html',
  styleUrls: ['./mod-p-lectivo.component.css'],
  providers: [
    {provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE]},
    {provide: MAT_DATE_FORMATS, useValue: MY_FORMATS},
  ]
})
export class ModPLectivoComponent implements OnInit {

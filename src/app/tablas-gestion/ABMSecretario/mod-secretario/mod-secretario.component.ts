...
@Component({
  selector: 'app-mod-secretario',
  templateUrl: './mod-secretario.component.html',
  styleUrls: ['./mod-secretario.component.css'],
  providers: [
    {provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE]},
    {provide: MAT_DATE_FORMATS, useValue: MY_FORMATS}
  ]
})
export class ModSecretarioComponent implements OnInit {
